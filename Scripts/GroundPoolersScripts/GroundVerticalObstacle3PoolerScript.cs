...
public class GroundVerticalObstacle3PoolerScript : MonoBehaviour
{
    public GameObject pooledObject;                                     //Oggetto singolare
    public static GroundVerticalObstacle3PoolerScript obstacle3Script;
    ...
    private void Awake()
    {
        if (obstacle3Script == null)
        {
            obstacle3Script = this;
        }
    }
