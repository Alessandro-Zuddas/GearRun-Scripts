...
public class GroundVerticalObstacle6PoolerScript : MonoBehaviour
{
    public GameObject pooledObject;                                     //Oggetto singolare
    public static GroundVerticalObstacle6PoolerScript obstacle6Script;
    ...
    private void Awake()
    {
        if (obstacle6Script == null)
        {
            obstacle6Script = this;
        }
    }
